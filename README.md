...
- [Download the DS&AI additional admission form 2025-2026](https://github.com/Ivayla377/dsai-admission-forms/releases/latest/download/dsai-admission-2025-2026.html)
- [Download the DS&AI additional admission form 2026-2027](https://github.com/Ivayla377/dsai-admission-forms/releases/latest/download/dsai-admission-2026-2027.html)
...
- `src/survey-model.js` creates the questionnaire from Form JSON and connects
  its validation and help behavior.
- `src/main.js` displays the questionnaire and handles page navigation,
